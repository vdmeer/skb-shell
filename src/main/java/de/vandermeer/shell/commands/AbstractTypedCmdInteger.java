...
public abstract class AbstractTypedCmdInteger extends AbstractTypedCmd<Integer> {
	 ...
	 */
	protected AbstractTypedCmdInteger(String name, String displayName, String description, Sh_CmdCategory category, String argumentName, String argumentDescription, boolean argRequired, Integer defaultValue) {
